...
export async function action({ request, params }: ActionFunctionArgs) {
    ...
    */
    ...
    /** Main form entrypoint
     */
    // ======== execute code to get_outputs_natural_gas ======
    const response = await fetch('http://localhost:3000/pyodide-env/execute_get_outputs_natural_gas.py');
    let pythonCode = await response.text();
    pythonCode = pythonCode.trim()
    const executeGetAnalyticsFromFormJs = await pyodide.runPythonAsync(pythonCode);
